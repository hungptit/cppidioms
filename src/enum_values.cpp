...
enum QueryAttributes : uint32_t
{
    ...
    UserSpecific = 4,      //< Query has user references (only defined for abstract queries).
    ContainsTempTable = 8, //< Query contains temp tables (only defined for native queries).
};
